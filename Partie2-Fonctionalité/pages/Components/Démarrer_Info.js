...
class Démarrer_Info extends React.Component {
            ...
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <View style={{ flexDirection: "row", flex: 0.15, marginTop: 20 }}>
                        <Left style={{ margin: 10, marginRight: 10 }}>
                            <Button block
                                iconLeft
                        ...
                        <View style={{ flex: 1, marginTop: 6, marginRight: 10, marginLeft: 10 }}>
                            <Button block
                                iconLeft
                                backgroundColor="#F3F3F2"
                        ...
                        <Right style={{ margin: 10, marginLeft: 10 }}>
                            <Button block
                                iconRight
                                backgroundColor="#f3f3f3"
